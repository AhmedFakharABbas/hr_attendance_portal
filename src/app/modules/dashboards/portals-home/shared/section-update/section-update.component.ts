...
export class SectionUpdateComponent implements OnInit {
  ...
  storage = 'https://staging.peoplei.tech/uat/104/people/';
  updates = [
    {
      icon: this.storage + 'images/ico_approved.gif',
    ...
    {
      icon: this.storage + 'images/ico_rejected.gif',
    ...
    {
      icon: this.storage + 'images/ico_pending.png',
